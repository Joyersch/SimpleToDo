...
class ToDo extends DatabaseObject
{
    ...
    public function GetByID($ID) {
        ...
        $result = $this -> connection -> query("SELECT Text,Category FROM ToDo WHERE ID = $ID LIMIT 0,1");
    ...
    public function Add() {
        ...
        $result = $this -> connection -> query(@"INSERT INTO ToDo (Text, Category) VALUES ('{$this -> Text}', {$this -> Category -> ID})");
    ...
    public function Update(){
        ...
        # Runs update
        return $this -> connection -> query(@"UPDATE ToDo SET Text = '{$this -> Text}', Category = {$this -> Category -> ID} WHERE ID = {$this -> ID}");
    }
    ...
    public function GetUnderlyingEntries() : array{
        ...
        $result = $this -> connection -> query(@"SELECT ID FROM Entry WHERE LinkedToDo = {$this -> ID} AND LinkedEntry IS NULL");
