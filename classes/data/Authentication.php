...
class Authentication extends DatabaseObject
{
    ...
    public function GetByKey($Key){
        ...
        # query data
        $result = $this -> connection -> query("SELECT Name, StartTime, EndTime, PassKey FROM Authentication WHERE PassKey = '$Key' LIMIT 0,1");
    ...
    public function GetByName($Name){
        ...
        $result = $this -> connection -> query("SELECT StartTime, EndTime, PassKey FROM Authentication WHERE Name = '$Name' LIMIT 0,1");
    ...
    public function Add(){
        ...
        $result = $this -> connection -> query(@"INSERT INTO Authentication (Name, StartTime, EndTime) VALUES ('{$this -> Name}','{$this -> StartTime}','{$this -> EndTime}')");

        if (!$result)
            return false;

        $result = $this -> connection -> query(@"SELECT PassKey FROM Authentication WHERE Name ='{$this -> Name}'");
    ...
    public function Delete(){
        ...
        return $this -> connection -> query(@"DELETE FROM Authentication WHERE Name = '{$this -> Name}'");
    }
}